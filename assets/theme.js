...
theme.TouchEvents.prototype = Object.assign({}, theme.TouchEvents.prototype, {
  ...
  _setupEventHandlers: function() {
    ...
    this.element.addEventListener(
      'dragstart',
      this.eventHandlers.preventDefault, {passive: true}
    );

    // Bind the touchstart/pointerdown event
    this.element.addEventListener(
      this.events[this.eventModel][0],
      this.eventHandlers.touchStart, {passive: true}
    );
    ...
    this.element.addEventListener('click', this.eventHandlers.preventClick, {passive: true});
  },
  ...
  _touchStart: function(event) {
    ...
    document.addEventListener(
      ...
      this.eventHandlers.touchMove, {passive: true}
    );

    document.addEventListener(
      this.events[this.eventType][2],
      this.eventHandlers.touchEnd, {passive: true}
    );
...
theme.Drawers = (function() {
  ...
  Drawer.prototype.init = function() {
    document
      ...
      .addEventListener('click', this.open.bind(this), {passive: true});
    this.drawer
      .querySelector(this.config.selectors.close)
      .addEventListener('click', this.close.bind(this), {passive: true});
  };
  ...
  Drawer.prototype.bindEvents = function() {
    ...
    document.body.addEventListener(
      'keyup',
      this.eventHandlers.drawerKeyupHandler, {passive: true}
    );

    // Lock scrolling on mobile
    this.nodes.page.addEventListener(
      'touchmove',
      this.eventHandlers.drawerTouchmoveHandler, {passive: true}
    );

    this.nodes.page.addEventListener(
      'click',
      this.eventHandlers.drawerClickHandler, {passive: true}
    );
  };
